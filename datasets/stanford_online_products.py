...
def Give(opt, datapath):
    ...
    training_files = pd.read_table(opt.source_path+'/Ebay_train.txt', header=0, delimiter=' ')
    test_files     = pd.read_table(opt.source_path+'/Ebay_test.txt', header=0, delimiter=' ')
